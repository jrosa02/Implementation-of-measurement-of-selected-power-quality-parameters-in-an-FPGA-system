###########################################################################
## Makefile generated for component 'float_model'. 
## 
## Makefile     : float_model.mk
## Generated on : Sat Nov 02 11:21:10 2024
## Final product: ./float_model.exe
...
PRODUCT_NAME              = float_model
MAKEFILE                  = float_model.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/AGH_Files/Implementation-of-measurement-of-selected-power-quality-parameters-in-an-FPGA-system/Matlab_float_model
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = float_model_comp.rsp
CMD_FILE                  = float_model.rsp
...
DEFINES_STANDARD = -DMODEL=float_model -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/float_model/float_model.c $(START_DIR)/slprj/raccel/float_model/float_model_capi.c $(START_DIR)/slprj/raccel/float_model/float_model_data.c $(START_DIR)/slprj/raccel/float_model/float_model_tgtconn.c $(START_DIR)/slprj/raccel/float_model/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = float_model.obj float_model_capi.obj float_model_data.obj float_model_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/float_model/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/float_model/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/float_model/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/float_model/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/float_model/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
float_model.obj : $(START_DIR)/slprj/raccel/float_model/float_model.c
	$(CC) $(CFLAGS) -o "$@" "$<"


float_model_capi.obj : $(START_DIR)/slprj/raccel/float_model/float_model_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


float_model_data.obj : $(START_DIR)/slprj/raccel/float_model/float_model_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


float_model_tgtconn.obj : $(START_DIR)/slprj/raccel/float_model/float_model_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/float_model/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
