// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_SDFCommuta_block6.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_SDFCommuta_block6
// Source Path: hdl_model_fixed/Subsystem1/Subsystem/FFT/RADIX22FFT_SDF2_8/SDFCommutator8
// Hierarchy Level: 4
// Model version: 1.105
// 
// -------------------------------------------------------------
...
module Subsystem_ip2_src_SDFCommuta_block6
  ...
  input   enb;
  input   dout_7_1_vld;
  input   signed [19:0] xf_re;  // sfix20_En11
  input   signed [19:0] xf_im;  // sfix20_En11
  input   xf_vld;
  input   signed [19:0] dinf_re;  // sfix20_En11
  input   signed [19:0] dinf_im;  // sfix20_En11
  input   dinf_vld;
  input   signed [19:0] btf1_re;  // sfix20_En11
  input   signed [19:0] btf1_im;  // sfix20_En11
  input   signed [19:0] btf2_re;  // sfix20_En11
  input   signed [19:0] btf2_im;  // sfix20_En11
  input   btfout_vld;
  input   syncReset;
  output  signed [19:0] wrData_re;  // sfix20_En11
  output  signed [19:0] wrData_im;  // sfix20_En11
  ...
  reg signed [19:0] SDFCummutator_out_re_next;  // sfix20_En11
  reg signed [19:0] SDFCummutator_out_im_next;  // sfix20_En11
  reg  SDFCummutator_out_vld_next;
  reg [2:0] SDFCummutator_wrAddr_reg_next;  // ufix3
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [19:0] SDFCummutator_wrData_re_reg_next;  // sfix20_En11
  reg signed [19:0] SDFCummutator_wrData_im_reg_next;  // sfix20_En11
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [19:0] SDFCummutator_wrXData_re_reg_next;  // sfix20_En11
  reg signed [19:0] SDFCummutator_wrXData_im_reg_next;  // sfix20_En11
  ...
  reg signed [19:0] wrData_re_1;  // sfix20_En11
  reg signed [19:0] wrData_im_1;  // sfix20_En11
  reg [2:0] wrAddr_1;  // ufix3
  reg  wrEnb_1;
  reg signed [19:0] xData_re;  // sfix20_En11
  reg signed [19:0] xData_im;  // sfix20_En11
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [19:0] dout0_re;  // sfix20_En11
  reg signed [19:0] dout0_im;  // sfix20_En11
  reg  dout0_vld;
  wire signed [19:0] xX_re;  // sfix20_En11
  wire signed [19:0] xX_im;  // sfix20_En11
  reg signed [19:0] SDFOutmux_btf2Pipe_re;  // sfix20
  reg signed [19:0] SDFOutmux_btf2Pipe_im;  // sfix20
  reg  SDFOutmux_btfPipe_vld;
  reg signed [19:0] SDFOutmux_btf2Pipe_re_next;  // sfix20_En11
  reg signed [19:0] SDFOutmux_btf2Pipe_im_next;  // sfix20_En11
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [19:0] dout_8_1_re_1;  // sfix20_En11
  reg signed [19:0] dout_8_1_im_1;  // sfix20_En11
  reg  dout_8_1_vld_1;
  ...
  always @(SDFCummutator_XState, SDFCummutator_out_im, SDFCummutator_out_re,
       ...
       dinf_im, dinf_re, dinf_vld, dout_7_1_vld) begin
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_8_1_re_1 = SDFOutmux_btf2Pipe_re;
    dout_8_1_im_1 = SDFOutmux_btf2Pipe_im;
    dout_8_1_vld_1 = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_8_1_re = dout_8_1_re_1;

  assign dout_8_1_im = dout_8_1_im_1;

  assign dout_8_1_vld = dout_8_1_vld_1;

endmodule  // Subsystem_ip2_src_SDFCommuta_block6
