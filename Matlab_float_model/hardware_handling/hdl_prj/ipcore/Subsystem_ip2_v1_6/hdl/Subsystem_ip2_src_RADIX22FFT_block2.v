// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_RADIX22FFT_block2.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_RADIX22FFT_block2
// Source Path: hdl_model_fixed/Subsystem1/Subsystem/FFT/RADIX22FFT_CTRL1_2
// Hierarchy Level: 3
// Model version: 1.105
// 
// -------------------------------------------------------------
...
module Subsystem_ip2_src_RADIX22FFT_block2
  ...
  always @(posedge clk)
    begin : SDFController_process
      if (reset == 1'b1) begin
        SDFController_wrCount <= 9'b000000000;
        SDFController_rdAddr_reg <= 9'b000000000;
    ...
    case ( SDFController_rdState)
      2'b00 :
        begin
          ...
          SDFController_rdAddr_reg_next = 9'b000000000;
          rd_2_Enb_1 = 1'b0;
          if (dout_1_1_vld && (SDFController_wrCount == 9'b111111111)) begin
      ...
      2'b01 :
        begin
          ...
          if (dinXTwdl_2_1_vld) begin
            if (SDFController_rdAddr_reg == 9'b111111111) begin
              SDFController_rdState_next = 2'b10;
            end
            SDFController_rdAddr_reg_next = SDFController_rdAddr_reg + 9'b000000001;
          end
        end
      2'b10 :
        begin
    ...
    case ( SDFController_wrState)
      ...
      2'b01 :
        begin
          ...
          SDFController_procEnb_reg_next = 1'b0;
          if (dout_1_1_vld) begin
            if (SDFController_wrCount == 9'b111111111) begin
            ...
            SDFController_wrCount_next = SDFController_wrCount + 9'b000000001;
          end
        end
      2'b10 :
        begin
      ...
      default :
        begin
          SDFController_wrState_next = 2'b00;
          SDFController_wrCount_next = 9'b111111111;
          SDFController_procEnb_reg_next = 1'b0;
        end
    endcase
...
endmodule  // Subsystem_ip2_src_RADIX22FFT_block2
