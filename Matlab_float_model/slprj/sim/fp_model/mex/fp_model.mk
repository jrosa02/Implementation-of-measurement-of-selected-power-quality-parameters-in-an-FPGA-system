...
## Generated on : Fri Aug 09 09:49:48 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fp_model_msf.mexw64
...
MODELREF_LINK_RSPFILE     = fp_model_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fp_model_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/fp_model/fp_model_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = fp_model_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = D:/AGH_Files/Implementation-of-measurement-of-selected-power-quality-parameters-in-an-FPGA-system/Matlab_float_model/slprj/sim/fp_model/fp_modellib.lib
...
SYSTEM_LIBS =  -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -llibmwipp -llibfixedpoint -llibmwmathutil -llibmwsl_AsyncioQueue -lsf_runtime -llibmwslexec_simlog -llibmwcoder_ToAsyncQueueTgtAppSvc -llibmwsl_simtarget_instrumentation -llibmwsl_simtarget_core -llibmwstringutil -llibemlrt -llibmx -llibmex
...
fp_model_msf.obj : $(START_DIR)/slprj/sim/fp_model/fp_model_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
