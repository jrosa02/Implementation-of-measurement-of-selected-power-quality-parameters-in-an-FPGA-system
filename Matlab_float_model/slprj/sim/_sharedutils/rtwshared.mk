...
MWDSPCG_FFT_DblLen_Z.obj : $(START_DIR)/slprj/sim/_sharedutils/MWDSPCG_FFT_DblLen_Z.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MWDSPCG_FFT_Interleave_R2BR_D.obj : $(START_DIR)/slprj/sim/_sharedutils/MWDSPCG_FFT_Interleave_R2BR_D.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MWDSPCG_R2DIT_TBLS_Z.obj : $(START_DIR)/slprj/sim/_sharedutils/MWDSPCG_R2DIT_TBLS_Z.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
sumColumnB_iybGJ3jg.obj : $(START_DIR)/slprj/sim/_sharedutils/sumColumnB_iybGJ3jg.c
	$(CC) $(CFLAGS) -o "$@" "$<"
