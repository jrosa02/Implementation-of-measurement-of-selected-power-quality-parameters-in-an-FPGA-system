#ifndef __fixedp_model_sfun_h__
#define __fixedp_model_sfun_h__
...
extern mxArray* load_fixedp_model_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_fixedp_model_optimization_info(void);
