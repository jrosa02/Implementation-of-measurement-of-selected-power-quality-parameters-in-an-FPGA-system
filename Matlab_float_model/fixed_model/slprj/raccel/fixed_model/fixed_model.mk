###########################################################################
## Makefile generated for component 'fixed_model'. 
## 
## Makefile     : fixed_model.mk
## Generated on : Sat Nov 02 11:21:29 2024
## Final product: ./fixed_model.exe
...
COMPILER_COMMAND_FILE     = fixed_model_comp.rsp
CMD_FILE                  = fixed_model.rsp
...
DEFINES_STANDARD = -DMODEL=fixed_model -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/fixed_model/fixed_model.c $(START_DIR)/slprj/raccel/fixed_model/fixed_model_capi.c $(START_DIR)/slprj/raccel/fixed_model/fixed_model_data.c $(START_DIR)/slprj/raccel/fixed_model/fixed_model_tgtconn.c $(START_DIR)/slprj/raccel/fixed_model/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
%.obj : $(START_DIR)/slprj/raccel/fixed_model/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/fixed_model/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/fixed_model/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/fixed_model/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/fixed_model/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
fixed_model.obj : $(START_DIR)/slprj/raccel/fixed_model/fixed_model.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fixed_model_capi.obj : $(START_DIR)/slprj/raccel/fixed_model/fixed_model_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fixed_model_data.obj : $(START_DIR)/slprj/raccel/fixed_model/fixed_model_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fixed_model_tgtconn.obj : $(START_DIR)/slprj/raccel/fixed_model/fixed_model_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/fixed_model/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
