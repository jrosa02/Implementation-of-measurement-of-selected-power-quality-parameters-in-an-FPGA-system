#ifndef __float_model_sfun_h__
#define __float_model_sfun_h__
...
extern mxArray* load_float_model_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_float_model_optimization_info(void);
