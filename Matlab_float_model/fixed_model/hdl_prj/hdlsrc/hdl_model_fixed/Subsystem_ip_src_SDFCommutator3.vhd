-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_SDFCommutator3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_SDFCommutator3
-- Source Path: hdl_model_fixed/Subsystem1/FFT/RADIX22FFT_SDF1_3/SDFCommutator3
-- Hierarchy Level: 3
-- Model version: 1.22
-- 
-- -------------------------------------------------------------
...
ENTITY Subsystem_ip_src_SDFCommutator3 IS
...
END Subsystem_ip_src_SDFCommutator3;


ARCHITECTURE rtl OF Subsystem_ip_src_SDFCommutator3 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL xf_im_signed                     : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL dinXTwdlf_re_signed              : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL dinXTwdlf_im_signed              : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL btf1_re_signed                   : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL btf1_im_signed                   : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL btf2_re_signed                   : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL btf2_im_signed                   : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL SDFCummutator_out_re             : signed(14 DOWNTO 0);  -- sfix15
  SIGNAL SDFCummutator_out_im             : signed(14 DOWNTO 0);  -- sfix15
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(14 DOWNTO 0);  -- sfix15
  SIGNAL SDFCummutator_wrData_im_reg      : signed(14 DOWNTO 0);  -- sfix15
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(14 DOWNTO 0);  -- sfix15
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(14 DOWNTO 0);  -- sfix15
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL SDFCummutator_out_im_next        : signed(14 DOWNTO 0);  -- sfix15_En11
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(14 DOWNTO 0);  -- sfix15_En11
  ...
  SIGNAL wrData_re_tmp                    : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL wrData_im_tmp                    : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL wrAddr_tmp                       : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL xData_re                         : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL xData_im                         : signed(14 DOWNTO 0);  -- sfix15_En11
  ...
  SIGNAL dout0_re                         : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL dout0_im                         : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(14 DOWNTO 0);  -- ufix15
  SIGNAL xX_re_signed                     : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL xX_im                            : std_logic_vector(14 DOWNTO 0);  -- ufix15
  SIGNAL xX_im_signed                     : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(14 DOWNTO 0);  -- sfix15
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(14 DOWNTO 0);  -- sfix15
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_3_1_re_tmp                  : signed(14 DOWNTO 0);  -- sfix15_En11
  SIGNAL dout_3_1_im_tmp                  : signed(14 DOWNTO 0);  -- sfix15_En11

BEGIN
  u_dataXMEM_re_0_3 : Subsystem_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_3 : Subsystem_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 15
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(16#0000#, 15);
      SDFCummutator_out_im <= to_signed(16#0000#, 15);
      SDFCummutator_wrData_re_reg <= to_signed(16#0000#, 15);
      SDFCummutator_wrData_im_reg <= to_signed(16#0000#, 15);
      ...
      SDFCummutator_wrXData_re_reg <= to_signed(16#0000#, 15);
      SDFCummutator_wrXData_im_reg <= to_signed(16#0000#, 15);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        SDFCummutator_wrXData_re_reg_next <= to_signed(16#0000#, 15);
        SDFCummutator_wrXData_im_reg_next <= to_signed(16#0000#, 15);
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(16#0000#, 15);
      SDFOutmux_btf2Pipe_im <= to_signed(16#0000#, 15);
