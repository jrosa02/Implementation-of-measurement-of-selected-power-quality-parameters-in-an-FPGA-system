-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_SDF1_9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_SDF1_9
-- Source Path: hdl_model_fixed/Subsystem1/FFT/RADIX22FFT_SDF1_9
-- Hierarchy Level: 2
-- Model version: 1.22
-- 
-- -------------------------------------------------------------
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDF1_9 IS
...
END Subsystem_ip_src_RADIX22FFT_SDF1_9;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDF1_9 IS
  ...
  COMPONENT Subsystem_ip_src_Complex4Multiply_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_25_0                      :   IN    std_logic;
          din_re                          :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          din_im                          :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          din_9_vld_dly                   :   IN    std_logic;
          twdl_9_1_re                     :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
          twdl_9_1_im                     :   IN    std_logic_vector(11 DOWNTO 0);  -- sfix12_En10
          syncReset                       :   IN    std_logic;
          dinXTwdl_re                     :   OUT   std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          dinXTwdl_im                     :   OUT   std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          dinXTwdl_9_1_vld                :   OUT   std_logic
          );
  END COMPONENT;
  ...
  COMPONENT Subsystem_ip_src_SDFCommutator9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_25_0                      :   IN    std_logic;
          din_9_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          xf_im                           :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          dinXTwdlf_im                    :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          btf1_im                         :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          btf2_re                         :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          btf2_im                         :   IN    std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          btf_vld                         :   IN    std_logic;
          syncReset                       :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
          wrData_im                       :   OUT   std_logic_vector(20 DOWNTO 0);  -- sfix21_En11
  ...
  FOR ALL : Subsystem_ip_src_SDFCommutator9
    USE ENTITY work.Subsystem_ip_src_SDFCommutator9(rtl);

  -- Signals
  SIGNAL din_9_1_re_dly_signed            : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL din_re                           : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL din_9_1_im_dly_signed            : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL din_im                           : signed(20 DOWNTO 0);  -- sfix21_En11
  ...
  SIGNAL dinXTwdl_re_signed               : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL dinXTwdl_im_signed               : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL btf2_re                          : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL btf1_im                          : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL btf1_re                          : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL dinXTwdlf_im                     : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL dinXTwdlf_re                     : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL xf_im                            : signed(20 DOWNTO 0);  -- sfix21_En11
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_add_cast      : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(21 DOWNTO 0);  -- sfix22_En11
  SIGNAL xf_re                            : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinxTwdlf_vld                    : std_logic;
  SIGNAL btf_vld                          : std_logic;
  SIGNAL dout_9_1_re_tmp                  : std_logic_vector(20 DOWNTO 0);  -- ufix21
  SIGNAL dout_9_1_im_tmp                  : std_logic_vector(20 DOWNTO 0);  -- ufix21

BEGIN
  u_MUL4 : Subsystem_ip_src_Complex4Multiply_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_25_0 => enb_1_25_0,
              din_re => std_logic_vector(din_re),  -- sfix21_En11
              din_im => std_logic_vector(din_im),  -- sfix21_En11
  ...
  u_dataMEM_im_0_9 : Subsystem_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_9 : Subsystem_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 21
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_9 : Subsystem_ip_src_SDFCommutator9
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_25_0 => enb_1_25_0,
              din_9_vld_dly => din_9_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix21_En11
              xf_im => std_logic_vector(xf_im),  -- sfix21_En11
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix21_En11
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix21_En11
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix21_En11
              btf1_im => std_logic_vector(btf1_im),  -- sfix21_En11
              btf2_re => std_logic_vector(btf2_re),  -- sfix21_En11
              btf2_im => std_logic_vector(btf2_im),  -- sfix21_En11
              btf_vld => btf_vld,
              syncReset => syncReset,
              ...
              wrAddr => wrAddr,  -- ufix2
              wrEnb => wrEnb,
              dout_9_1_re => dout_9_1_re_tmp,  -- sfix21_En11
              dout_9_1_im => dout_9_1_im_tmp,  -- sfix21_En11
              dout_9_1_vld => dout_9_1_vld
              );

  din_9_1_re_dly_signed <= signed(din_9_1_re_dly);

  din_re <= resize(din_9_1_re_dly_signed, 21);

  din_9_1_im_dly_signed <= signed(din_9_1_im_dly);

  din_im <= resize(din_9_1_im_dly_signed, 21);
