-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX2FFT_bitNatural.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX2FFT_bitNatural
...
ENTITY Subsystem_ip_src_RADIX2FFT_bitNatural IS
...
END Subsystem_ip_src_RADIX2FFT_bitNatural;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX2FFT_bitNatural IS
  ...
  SIGNAL memOut_im                        : std_logic_vector(22 DOWNTO 0);  -- ufix23
  SIGNAL memOut_im_signed                 : signed(22 DOWNTO 0);  -- sfix23_En11
  SIGNAL memOut_re                        : std_logic_vector(22 DOWNTO 0);  -- ufix23
  SIGNAL memOut_re_signed                 : signed(22 DOWNTO 0);  -- sfix23_En11
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg : signed(22 DOWNTO 0);  -- sfix23
  SIGNAL rdStateMachineBitNatural_doutImReg : signed(22 DOWNTO 0);  -- sfix23
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(22 DOWNTO 0);  -- sfix23_En11
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(22 DOWNTO 0);  -- sfix23_En11
  ...
  SIGNAL dout_re1_tmp                     : signed(22 DOWNTO 0);  -- sfix23_En11
  SIGNAL dout_im1_tmp                     : signed(22 DOWNTO 0);  -- sfix23_En11
  SIGNAL startOutW                        : std_logic;
  SIGNAL endOutW                          : std_logic;

BEGIN
  u_dataMEM_im_1 : Subsystem_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_1 : Subsystem_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 11,
                 DataWidth => 23
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdStateMachineBitNatural_doutReReg <= to_signed(16#000000#, 23);
      rdStateMachineBitNatural_doutImReg <= to_signed(16#000000#, 23);
