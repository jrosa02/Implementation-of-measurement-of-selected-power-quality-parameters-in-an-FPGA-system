// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_RADIX22FFT_SDF1_5.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_RADIX22FFT_SDF1_5
...
module Subsystem_ip2_src_RADIX22FFT_SDF1_5
  ...
  Subsystem_ip2_src_Complex4Multiply_block u_MUL4 (.clk(clk),
                                                   .reset(reset),
                                                   .enb_1_2_0(enb_1_2_0),
  ...
  Subsystem_ip2_src_SimpleDualPortRAM_generic #(.AddrWidth(6),
                                                .DataWidth(17)
                                                )
  ...
  Subsystem_ip2_src_SDFCommutator5 u_SDFCOMMUTATOR_5 (.clk(clk),
                                                      .reset(reset),
                                                      .enb_1_2_0(enb_1_2_0),
                                                      .din_5_vld_dly(din_5_vld_dly),
...
endmodule  // Subsystem_ip2_src_RADIX22FFT_SDF1_5
