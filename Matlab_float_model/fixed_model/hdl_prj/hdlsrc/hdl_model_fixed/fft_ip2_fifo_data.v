// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\fft_ip2_fifo_data.v
...
// -------------------------------------------------------------
// 
// Module: fft_ip2_fifo_data
// Source Path: fft_ip2/fft_ip2_axi4_stream_slave/fft_ip2_fifo_data
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module fft_ip2_fifo_data
  ...
  input   reset;
  input   enb;
  input   [15:0] In_rsvd;  // ufix16
  input   Push;  // ufix1
  input   Pop;  // ufix1
  output  [15:0] Out_rsvd;  // ufix16
  output  Empty;  // ufix1
  output  Full;  // ufix1
  ...
  wire w_mux1;  // ufix1
  reg  w_d1;  // ufix1
  wire [15:0] w_waddr_1;  // ufix16
  reg [15:0] w_d2;  // ufix16
  wire [15:0] w_out;  // ufix16
  reg [15:0] cache_data;  // ufix16
  wire [15:0] data_out_next;  // ufix16
  reg [15:0] Out_rsvd_1;  // ufix16
  ...
  fft_ip2_SimpleDualPortRAM_ge #(.AddrWidth(2),
                                 .DataWidth(16)
                                 )
                               fft_ip2_fifo_data_classic_ra (.clk(clk),
                                                             .enb(enb),
                                                             .wr_din(In_rsvd),
                                                             .wr_addr(w_waddr),
                                                             .wr_en(w_we),  // ufix1
  ...
  always @(posedge clk)
    begin : out_data_reg_process
      if (reset == 1'b1) begin
        Out_rsvd_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb && out_wr_en) begin
          Out_rsvd_1 <= data_out_next;
        end
      end
    end
  ...
  assign Out_rsvd = Out_rsvd_1;

endmodule  // fft_ip2_fifo_data
