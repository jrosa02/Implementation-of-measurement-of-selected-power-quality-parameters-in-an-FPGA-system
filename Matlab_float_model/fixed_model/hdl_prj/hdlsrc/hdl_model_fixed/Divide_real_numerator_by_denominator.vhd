-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Divide_real_numerator_by_denominator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Divide_real_numerator_by_denominator
...
ARCHITECTURE rtl OF Divide_real_numerator_by_denominator IS
  ...
  COMPONENT normalizedCORDICDivide
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_25_0                      :   IN    std_logic;
          num                             :   IN    std_logic_vector(21 DOWNTO 0);  -- sfix22_En20
  ...
  FOR ALL : normalizedCORDICDivide
    USE ENTITY work.normalizedCORDICDivide(rtl);
...
BEGIN
  u_normalizedCORDICDivide : normalizedCORDICDivide
    PORT MAP( clk => clk,
              reset => reset,
