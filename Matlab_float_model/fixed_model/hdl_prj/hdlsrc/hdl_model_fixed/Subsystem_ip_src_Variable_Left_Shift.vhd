-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_Variable_Left_Shift.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_Variable_Left_Shift
...
ENTITY Subsystem_ip_src_Variable_Left_Shift IS
...
END Subsystem_ip_src_Variable_Left_Shift;


ARCHITECTURE rtl OF Subsystem_ip_src_Variable_Left_Shift IS
  ...
  SIGNAL Bit_Shift_out1                   : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Switch1_out1                     : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Bit_Shift1_out1                  : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Switch2_out1                     : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Bit_Shift2_out1                  : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Switch3_out1                     : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Bit_Shift3_out1                  : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Switch4_out1                     : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Delay_out1                       : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Bit_Shift4_out1                  : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Switch5_out1                     : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Delay3_out1                      : std_logic;  -- ufix1
  SIGNAL Bit_Shift5_out1                  : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Switch6_out1                     : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Delay4_out1                      : std_logic;  -- ufix1
  SIGNAL Bit_Shift6_out1                  : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Switch7_out1                     : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Bit_Shift7_out1                  : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Switch8_out1                     : signed(21 DOWNTO 0);  -- sfix22_En20
...
BEGIN
  ...
  Bit_Shift5_out1 <= to_signed(16#000000#, 22);
  ...
  Bit_Shift6_out1 <= to_signed(16#000000#, 22);

  
  Switch7_out1 <= Switch6_out1 WHEN Delay3_out1 = '0' ELSE
      Bit_Shift6_out1;

  Bit_Shift7_out1 <= to_signed(16#000000#, 22);
