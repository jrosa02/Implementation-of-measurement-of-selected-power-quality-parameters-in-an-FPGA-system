-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_CTRL1_1_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_CTRL1_1_block
...
ENTITY Subsystem_ip_src_RADIX22FFT_CTRL1_1_block IS
...
END Subsystem_ip_src_RADIX22FFT_CTRL1_1_block;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_CTRL1_1_block IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_11_Enb <= '0';
        IF (SDFController_wrState = to_unsigned(16#3#, 2)) AND dinXTwdl_11_vld = '1' THEN 
