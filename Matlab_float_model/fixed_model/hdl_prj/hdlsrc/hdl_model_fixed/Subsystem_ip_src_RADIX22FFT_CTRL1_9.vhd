-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_CTRL1_9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_CTRL1_9
-- Source Path: hdl_model_fixed/Subsystem1/FFT/RADIX22FFT_CTRL1_9
-- Hierarchy Level: 2
-- Model version: 1.22
-- 
-- -------------------------------------------------------------
...
ENTITY Subsystem_ip_src_RADIX22FFT_CTRL1_9 IS
...
END Subsystem_ip_src_RADIX22FFT_CTRL1_9;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_CTRL1_9 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_9_Enb <= '0';
        IF dinXTwdl_9_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#3#, 2)) THEN 
