-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_CTRL1_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_CTRL1_3
...
ENTITY Subsystem_ip_src_RADIX22FFT_CTRL1_3 IS
...
END Subsystem_ip_src_RADIX22FFT_CTRL1_3;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_CTRL1_3 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_3_Enb <= '0';
        IF dinXTwdl_3_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#FF#, 8)) THEN 
