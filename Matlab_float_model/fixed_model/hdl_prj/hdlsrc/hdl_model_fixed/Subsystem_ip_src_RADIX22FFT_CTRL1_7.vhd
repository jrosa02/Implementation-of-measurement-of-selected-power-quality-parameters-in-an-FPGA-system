-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_CTRL1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_CTRL1_7
-- Source Path: hdl_model_fixed/Subsystem1/FFT/RADIX22FFT_CTRL1_7
-- Hierarchy Level: 2
-- Model version: 1.22
-- 
-- -------------------------------------------------------------
...
ENTITY Subsystem_ip_src_RADIX22FFT_CTRL1_7 IS
...
END Subsystem_ip_src_RADIX22FFT_CTRL1_7;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_CTRL1_7 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_7_Enb <= '0';
        IF dinXTwdl_7_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#F#, 4)) THEN 
