-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_CTRL1_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_CTRL1_5
...
ENTITY Subsystem_ip_src_RADIX22FFT_CTRL1_5 IS
...
END Subsystem_ip_src_RADIX22FFT_CTRL1_5;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_CTRL1_5 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_5_Enb <= '0';
        IF dinXTwdl_5_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#3F#, 6)) THEN 
