-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_Complex4Multiply_block3.vhd
...
ARCHITECTURE rtl OF Subsystem_ip_src_Complex4Multiply_block3 IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(22 DOWNTO 0);  -- sfix23_En11
  SIGNAL din_re_reg                       : signed(22 DOWNTO 0);  -- sfix23_En11
  SIGNAL din_im_signed                    : signed(22 DOWNTO 0);  -- sfix23_En11
  SIGNAL din_im_reg                       : signed(22 DOWNTO 0);  -- sfix23_En11
  SIGNAL twdl_11_re_signed                : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_re_reg                      : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_11_im_signed                : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL prod1_re                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En21
  SIGNAL prod1_im                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En21
  SIGNAL prod2_re                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En21
  SIGNAL prod2_im                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En21
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(35 DOWNTO 0);  -- sfix36_En21
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(35 DOWNTO 0);  -- sfix36_En21
  SIGNAL Complex4Add_sub_cast             : signed(35 DOWNTO 0);  -- sfix36_En21
  SIGNAL Complex4Add_sub_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En21
  SIGNAL Complex4Add_add_cast             : signed(35 DOWNTO 0);  -- sfix36_En21
  SIGNAL Complex4Add_add_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En21
  SIGNAL mulResFP_re                      : signed(35 DOWNTO 0);  -- sfix36_En21
  SIGNAL mulResFP_im                      : signed(35 DOWNTO 0);  -- sfix36_En21
  SIGNAL dinXTwdl_11_vld_1                : std_logic;
  SIGNAL dinXTwdl_re_tmp                  : signed(22 DOWNTO 0);  -- sfix23_En11
  SIGNAL dinXTwdl_im_tmp                  : signed(22 DOWNTO 0);  -- sfix23_En11
...
BEGIN
  ...
  dinXTwdl_re_tmp <= mulResFP_re(32 DOWNTO 10);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= mulResFP_im(32 DOWNTO 10);
