-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_CTRL1_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_CTRL1_8
...
ENTITY Subsystem_ip_src_RADIX22FFT_CTRL1_8 IS
...
END Subsystem_ip_src_RADIX22FFT_CTRL1_8;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_CTRL1_8 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_8_Enb <= '0';
        IF dout_7_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#7#, 3)) THEN 
