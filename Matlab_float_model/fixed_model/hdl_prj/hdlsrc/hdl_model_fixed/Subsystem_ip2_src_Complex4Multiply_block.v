// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_Complex4Multiply_block.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_Complex4Multiply_block
...
module Subsystem_ip2_src_Complex4Multiply_block
  ...
  input   reset;
  input   enb_1_2_0;
  input   signed [16:0] din_re;  // sfix17_En11
  input   signed [16:0] din_im;  // sfix17_En11
  input   din_5_vld_dly;
  input   signed [11:0] twdl_5_1_re;  // sfix12_En10
  input   signed [11:0] twdl_5_1_im;  // sfix12_En10
  input   syncReset;
  output  signed [16:0] dinXTwdl_re;  // sfix17_En11
  output  signed [16:0] dinXTwdl_im;  // sfix17_En11
  output  dinXTwdl_5_1_vld;


  reg signed [16:0] din_re_reg;  // sfix17_En11
  reg signed [16:0] din_im_reg;  // sfix17_En11
  ...
  reg signed [28:0] prod1_re;  // sfix29_En21
  reg signed [28:0] prod1_im;  // sfix29_En21
  reg signed [28:0] prod2_re;  // sfix29_En21
  reg signed [28:0] prod2_im;  // sfix29_En21
  reg  din_vld_dly1;
  reg  din_vld_dly2;
  reg  din_vld_dly3;
  reg  prod_vld;
  ...
  wire signed [29:0] Complex4Add_multRes_re_reg_next;  // sfix30_En21
  wire signed [29:0] Complex4Add_multRes_im_reg_next;  // sfix30_En21
  wire signed [29:0] Complex4Add_sub_cast;  // sfix30_En21
  wire signed [29:0] Complex4Add_sub_cast_1;  // sfix30_En21
  wire signed [29:0] Complex4Add_add_cast;  // sfix30_En21
  wire signed [29:0] Complex4Add_add_cast_1;  // sfix30_En21
  wire signed [29:0] mulResFP_re;  // sfix30_En21
  wire signed [29:0] mulResFP_im;  // sfix30_En21
  ...
  assign dinXTwdl_re = mulResFP_re[26:10];



  assign dinXTwdl_im = mulResFP_im[26:10];



  assign dinXTwdl_5_1_vld = dinXTwdl_5_1_vld_1;

endmodule  // Subsystem_ip2_src_Complex4Multiply_block
