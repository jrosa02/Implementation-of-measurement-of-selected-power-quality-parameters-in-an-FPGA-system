// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_RADIX22FFT_block11.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_RADIX22FFT_block11
...
module Subsystem_ip2_src_RADIX22FFT_block11
  ...
  Subsystem_ip2_src_Complex4Mu_block1 MUL4_2 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  Subsystem_ip2_src_SimpleDual #(.AddrWidth(4),
                                 .DataWidth(19)
                                 )
  ...
  Subsystem_ip2_src_SDFCommuta_block5 SDFCOMMUTATOR_7_1 (.clk(clk),
                                                         .reset(reset),
                                                         .enb(enb),
                                                         .din_7_vld_dly(din_7_vld_dly),
...
endmodule  // Subsystem_ip2_src_RADIX22FFT_block11
