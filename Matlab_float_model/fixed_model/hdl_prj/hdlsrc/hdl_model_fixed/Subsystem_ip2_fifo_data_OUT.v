...
module Subsystem_ip2_fifo_data_OUT
  ...
  input   reset;
  input   enb;
  input   [31:0] In_rsvd;  // ufix32
  input   Push;  // ufix1
  input   Pop;  // ufix1
  output  [31:0] Out_rsvd;  // ufix32
  output  Empty;  // ufix1
  output  AFull;  // ufix1
  ...
  Subsystem_ip2_SimpleDualPort #(.AddrWidth(2),
                                 .DataWidth(32)
                                 )
                               Subsystem_ip2_fifo_data_OUT_1 (.clk(clk),
                                                              .enb(enb),
                                                              .wr_din(In_rsvd),
                                                              .wr_addr(w_waddr),
                                                              .wr_en(w_we),  // ufix1
  ...
  always @(posedge clk)
    begin : out_data_reg_process
      if (reset == 1'b1) begin
        Out_rsvd_1 <= 32'b00000000000000000000000000000000;
      end
      else begin
