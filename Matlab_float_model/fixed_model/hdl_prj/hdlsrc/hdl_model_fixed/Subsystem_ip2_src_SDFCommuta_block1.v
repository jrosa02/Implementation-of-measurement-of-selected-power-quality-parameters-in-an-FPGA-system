// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_SDFCommuta_block1.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_SDFCommuta_block1
// Source Path: hdl_model_fixed/Subsystem1/Subsystem/FFT/RADIX22FFT_SDF1_3/SDFCommutator3
// Hierarchy Level: 4
// Model version: 1.113
// 
// -------------------------------------------------------------
...
module Subsystem_ip2_src_SDFCommuta_block1
  ...
  input   enb;
  input   din_3_vld_dly;
  input   signed [14:0] xf_re;  // sfix15_En11
  input   signed [14:0] xf_im;  // sfix15_En11
  input   xf_vld;
  input   signed [14:0] dinXTwdlf_re;  // sfix15_En11
  input   signed [14:0] dinXTwdlf_im;  // sfix15_En11
  input   dinxTwdlf_vld;
  input   signed [14:0] btf1_re;  // sfix15_En11
  input   signed [14:0] btf1_im;  // sfix15_En11
  input   signed [14:0] btf2_re;  // sfix15_En11
  input   signed [14:0] btf2_im;  // sfix15_En11
  input   btf_vld;
  input   syncReset;
  output  signed [14:0] wrData_re;  // sfix15_En11
  output  signed [14:0] wrData_im;  // sfix15_En11
  ...
  reg signed [14:0] SDFCummutator_out_re_next;  // sfix15_En11
  reg signed [14:0] SDFCummutator_out_im_next;  // sfix15_En11
  ...
  reg signed [14:0] SDFCummutator_wrData_re_reg_next;  // sfix15_En11
  reg signed [14:0] SDFCummutator_wrData_im_reg_next;  // sfix15_En11
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [14:0] SDFCummutator_wrXData_re_reg_next;  // sfix15_En11
  reg signed [14:0] SDFCummutator_wrXData_im_reg_next;  // sfix15_En11
  ...
  reg signed [14:0] wrData_re_1;  // sfix15_En11
  reg signed [14:0] wrData_im_1;  // sfix15_En11
  reg [7:0] wrAddr_1;  // ufix8
  reg  wrEnb_1;
  reg signed [14:0] xData_re;  // sfix15_En11
  reg signed [14:0] xData_im;  // sfix15_En11
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [14:0] dout0_re;  // sfix15_En11
  reg signed [14:0] dout0_im;  // sfix15_En11
  reg  dout0_vld;
  wire signed [14:0] xX_re;  // sfix15_En11
  wire signed [14:0] xX_im;  // sfix15_En11
  reg signed [14:0] SDFOutmux_btf2Pipe_re;  // sfix15
  reg signed [14:0] SDFOutmux_btf2Pipe_im;  // sfix15
  reg  SDFOutmux_btfPipe_vld;
  reg signed [14:0] SDFOutmux_btf2Pipe_re_next;  // sfix15_En11
  reg signed [14:0] SDFOutmux_btf2Pipe_im_next;  // sfix15_En11
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [14:0] dout_3_1_re_1;  // sfix15_En11
  reg signed [14:0] dout_3_1_im_1;  // sfix15_En11
  reg  dout_3_1_vld_1;
    ...
    case ( SDFCummutator_XState)
      3'b000 :
        begin
          ...
          if ((SDFCummutator_wrEnb_xmem && (SDFCummutator_wrAddr_reg == 8'b11110111)) && 
    ...
    case ( SDFCummutator_mem_btf_switch)
      ...
      2'b01 :
        begin
          SDFCummutator_mem_btf_switch_next = 2'b01;
          SDFCummutator_rdEnb_xmem_next = 1'b0;
          if ((SDFCummutator_rdCnt == 8'b11111111) && btf_vld) begin
...
endmodule  // Subsystem_ip2_src_SDFCommuta_block1
