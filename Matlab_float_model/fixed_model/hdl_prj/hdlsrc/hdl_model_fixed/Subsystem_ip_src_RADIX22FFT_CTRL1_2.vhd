-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_CTRL1_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_CTRL1_2
...
ENTITY Subsystem_ip_src_RADIX22FFT_CTRL1_2 IS
...
END Subsystem_ip_src_RADIX22FFT_CTRL1_2;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_CTRL1_2 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_2_Enb <= '0';
        IF dout_1_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#1FF#, 9)) THEN 
