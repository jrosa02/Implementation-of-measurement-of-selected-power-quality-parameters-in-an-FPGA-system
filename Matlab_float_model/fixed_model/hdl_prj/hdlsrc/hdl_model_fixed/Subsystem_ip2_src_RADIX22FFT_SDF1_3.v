// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_RADIX22FFT_SDF1_3.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_RADIX22FFT_SDF1_3
...
module Subsystem_ip2_src_RADIX22FFT_SDF1_3
  ...
  Subsystem_ip2_src_Complex4Multiply u_MUL4 (.clk(clk),
                                             .reset(reset),
                                             .enb_1_2_0(enb_1_2_0),
  ...
  Subsystem_ip2_src_SimpleDualPortRAM_generic #(.AddrWidth(8),
                                                .DataWidth(15)
                                                )
  ...
  Subsystem_ip2_src_SDFCommutator3 u_SDFCOMMUTATOR_3 (.clk(clk),
                                                      .reset(reset),
                                                      .enb_1_2_0(enb_1_2_0),
                                                      .din_3_vld_dly(din_3_vld_dly),
...
endmodule  // Subsystem_ip2_src_RADIX22FFT_SDF1_3
