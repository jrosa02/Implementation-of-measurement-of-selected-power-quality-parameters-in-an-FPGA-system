// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_axi4_stream_master.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_axi4_stream_master
...
module Subsystem_ip2_axi4_stream_master
  ...
  Subsystem_ip2_fifo_data_OUT u_Subsystem_ip2_fifo_data_OUT_inst (.clk(clk),
                                                                  .reset(reset),
                                                                  .enb(enb),
                                                                  .In(user_data),  // ufix16
                                                                  .Push(fifo_push),  // ufix1
                                                                  .Pop(AXI4_Stream_Master_TREADY),  // ufix1
                                                                  .Out(AXI4_Stream_Master_TDATA),  // ufix16
  ...
  Subsystem_ip2_fifo_TLAST_OUT u_Subsystem_ip2_fifo_TLAST_OUT_inst (.clk(clk),
                                                                    .reset(reset),
                                                                    .enb(enb),
                                                                    .In(auto_tlast),  // ufix1
                                                                    .Push(fifo_push),  // ufix1
...
endmodule  // Subsystem_ip2_axi4_stream_master
