// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\fft_ip2_SimpleDualPortRAM_ge.v
...
// -------------------------------------------------------------
// 
// Module: fft_ip2_SimpleDualPortRAM_ge

// Source Path: fft_ip2/fft_ip2_axi4_stream_master/fft_ip2_fifo_data_OUT/fft_ip2_fifo_data_OUT_classic/fft_ip2_SimpleDualPortRAM_generic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module fft_ip2_SimpleDualPortRAM_ge
  ...
  always @(posedge clk)
    begin : fft_ip2_SimpleDualPortRAM_generic_process
      if (enb == 1'b1) begin
        if (wr_en == 1'b1) begin
          ram[wr_addr] <= wr_din;
        end
...
endmodule  // fft_ip2_SimpleDualPortRAM_ge
