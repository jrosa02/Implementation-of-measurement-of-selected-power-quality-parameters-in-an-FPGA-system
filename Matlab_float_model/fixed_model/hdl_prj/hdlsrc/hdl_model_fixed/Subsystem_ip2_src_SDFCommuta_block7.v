// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_SDFCommuta_block7.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_SDFCommuta_block7
// Source Path: hdl_model_fixed/Subsystem1/Subsystem/FFT/RADIX22FFT_SDF1_9/SDFCommutator9
// Hierarchy Level: 4
// Model version: 1.113
// 
// -------------------------------------------------------------
...
module Subsystem_ip2_src_SDFCommuta_block7
  ...
  input   enb;
  input   din_9_vld_dly;
  input   signed [20:0] xf_re;  // sfix21_En11
  input   signed [20:0] xf_im;  // sfix21_En11
  input   xf_vld;
  input   signed [20:0] dinXTwdlf_re;  // sfix21_En11
  input   signed [20:0] dinXTwdlf_im;  // sfix21_En11
  input   dinxTwdlf_vld;
  input   signed [20:0] btf1_re;  // sfix21_En11
  input   signed [20:0] btf1_im;  // sfix21_En11
  input   signed [20:0] btf2_re;  // sfix21_En11
  input   signed [20:0] btf2_im;  // sfix21_En11
  input   btf_vld;
  input   syncReset;
  output  signed [20:0] wrData_re;  // sfix21_En11
  output  signed [20:0] wrData_im;  // sfix21_En11
  ...
  reg signed [20:0] SDFCummutator_out_re_next;  // sfix21_En11
  reg signed [20:0] SDFCummutator_out_im_next;  // sfix21_En11
  reg  SDFCummutator_out_vld_next;
  reg [1:0] SDFCummutator_wrAddr_reg_next;  // ufix2
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [20:0] SDFCummutator_wrData_re_reg_next;  // sfix21_En11
  reg signed [20:0] SDFCummutator_wrData_im_reg_next;  // sfix21_En11
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [20:0] SDFCummutator_wrXData_re_reg_next;  // sfix21_En11
  reg signed [20:0] SDFCummutator_wrXData_im_reg_next;  // sfix21_En11
  ...
  reg signed [20:0] wrData_re_1;  // sfix21_En11
  reg signed [20:0] wrData_im_1;  // sfix21_En11
  reg [1:0] wrAddr_1;  // ufix2
  reg  wrEnb_1;
  reg signed [20:0] xData_re;  // sfix21_En11
  reg signed [20:0] xData_im;  // sfix21_En11
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [20:0] dout0_re;  // sfix21_En11
  reg signed [20:0] dout0_im;  // sfix21_En11
  reg  dout0_vld;
  wire signed [20:0] xX_re;  // sfix21_En11
  wire signed [20:0] xX_im;  // sfix21_En11
  reg signed [20:0] SDFOutmux_btf2Pipe_re;  // sfix21
  reg signed [20:0] SDFOutmux_btf2Pipe_im;  // sfix21
  reg  SDFOutmux_btfPipe_vld;
  reg signed [20:0] SDFOutmux_btf2Pipe_re_next;  // sfix21_En11
  reg signed [20:0] SDFOutmux_btf2Pipe_im_next;  // sfix21_En11
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [20:0] dout_9_1_re_1;  // sfix21_En11
  reg signed [20:0] dout_9_1_im_1;  // sfix21_En11
  reg  dout_9_1_vld_1;
  ...
  always @(SDFCummutator_XState, SDFCummutator_out_im, SDFCummutator_out_re,
       ...
       dinXTwdlf_im, dinXTwdlf_re, din_9_vld_dly, dinxTwdlf_vld) begin
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_9_1_re_1 = SDFOutmux_btf2Pipe_re;
    dout_9_1_im_1 = SDFOutmux_btf2Pipe_im;
    dout_9_1_vld_1 = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_9_1_re = dout_9_1_re_1;

  assign dout_9_1_im = dout_9_1_im_1;

  assign dout_9_1_vld = dout_9_1_vld_1;

endmodule  // Subsystem_ip2_src_SDFCommuta_block7
