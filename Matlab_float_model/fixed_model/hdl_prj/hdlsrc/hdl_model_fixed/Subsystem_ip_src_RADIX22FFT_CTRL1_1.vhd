-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_CTRL1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_CTRL1_1
...
ENTITY Subsystem_ip_src_RADIX22FFT_CTRL1_1 IS
...
END Subsystem_ip_src_RADIX22FFT_CTRL1_1;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_CTRL1_1 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_1_Enb <= '0';
        IF dinXTwdl_1_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#3FF#, 10)) THEN 
