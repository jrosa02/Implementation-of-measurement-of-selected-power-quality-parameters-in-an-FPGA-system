// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_RADIX22FFT_SDF1_7.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_RADIX22FFT_SDF1_7
...
module Subsystem_ip2_src_RADIX22FFT_SDF1_7
  ...
  Subsystem_ip2_src_Complex4Multiply_block1 u_MUL4 (.clk(clk),
                                                    .reset(reset),
                                                    .enb_1_2_0(enb_1_2_0),
  ...
  Subsystem_ip2_src_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                                .DataWidth(19)
                                                )
  ...
  Subsystem_ip2_src_SDFCommutator7 u_SDFCOMMUTATOR_7 (.clk(clk),
                                                      .reset(reset),
                                                      .enb_1_2_0(enb_1_2_0),
                                                      .din_7_vld_dly(din_7_vld_dly),
...
endmodule  // Subsystem_ip2_src_RADIX22FFT_SDF1_7
