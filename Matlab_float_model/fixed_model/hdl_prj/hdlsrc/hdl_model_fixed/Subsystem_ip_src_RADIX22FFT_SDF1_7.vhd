-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_SDF1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_SDF1_7
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDF1_7 IS
...
END Subsystem_ip_src_RADIX22FFT_SDF1_7;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDF1_7 IS
  ...
  COMPONENT Subsystem_ip_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_25_0                      :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_SDFCommutator7
    USE ENTITY work.Subsystem_ip_src_SDFCommutator7(rtl);
...
BEGIN
  u_MUL4 : Subsystem_ip_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_7 : Subsystem_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_7 : Subsystem_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 19
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_7 : Subsystem_ip_src_SDFCommutator7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_25_0 => enb_1_25_0,
              din_7_vld_dly => din_7_vld_dly,
