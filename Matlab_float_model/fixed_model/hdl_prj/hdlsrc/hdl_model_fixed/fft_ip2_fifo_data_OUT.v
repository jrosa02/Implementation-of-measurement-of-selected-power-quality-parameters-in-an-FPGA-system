// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\fft_ip2_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: fft_ip2_fifo_data_OUT
// Source Path: fft_ip2/fft_ip2_axi4_stream_master/fft_ip2_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module fft_ip2_fifo_data_OUT
  ...
  input   reset;
  input   enb;
  input   [11:0] In_rsvd;  // ufix12
  input   Push;  // ufix1
  input   Pop;  // ufix1
  output  [11:0] Out_rsvd;  // ufix12
  output  Empty;  // ufix1
  output  AFull;  // ufix1
  ...
  fft_ip2_SimpleDualPortRAM_ge #(.AddrWidth(2),
                               ...
                               fft_ip2_fifo_data_OUT_classi (.clk(clk),
                                                             .enb(enb),
                                                             .wr_din(In_rsvd),
                                                             .wr_addr(w_waddr),
                                                             .wr_en(w_we),  // ufix1
...
endmodule  // fft_ip2_fifo_data_OUT
