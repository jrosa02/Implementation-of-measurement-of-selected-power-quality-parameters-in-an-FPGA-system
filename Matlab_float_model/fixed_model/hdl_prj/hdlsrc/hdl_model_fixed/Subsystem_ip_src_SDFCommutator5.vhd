-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_SDFCommutator5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_SDFCommutator5
-- Source Path: hdl_model_fixed/Subsystem1/FFT/RADIX22FFT_SDF1_5/SDFCommutator5
-- Hierarchy Level: 3
-- Model version: 1.22
-- 
-- -------------------------------------------------------------
...
ENTITY Subsystem_ip_src_SDFCommutator5 IS
...
END Subsystem_ip_src_SDFCommutator5;


ARCHITECTURE rtl OF Subsystem_ip_src_SDFCommutator5 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL xf_im_signed                     : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL dinXTwdlf_re_signed              : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL dinXTwdlf_im_signed              : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL btf1_re_signed                   : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL btf1_im_signed                   : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL btf2_re_signed                   : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL btf2_im_signed                   : signed(16 DOWNTO 0);  -- sfix17_En11
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL SDFCummutator_out_im_next        : signed(16 DOWNTO 0);  -- sfix17_En11
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En11
  ...
  SIGNAL wrData_re_tmp                    : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL wrData_im_tmp                    : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL wrAddr_tmp                       : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL xData_re                         : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL xData_im                         : signed(16 DOWNTO 0);  -- sfix17_En11
  ...
  SIGNAL dout0_re                         : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL dout0_im                         : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL xX_re_signed                     : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL xX_im                            : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL xX_im_signed                     : signed(16 DOWNTO 0);  -- sfix17_En11
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_5_1_re_tmp                  : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL dout_5_1_im_tmp                  : signed(16 DOWNTO 0);  -- sfix17_En11

BEGIN
  u_dataXMEM_re_0_5 : Subsystem_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_5 : Subsystem_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
