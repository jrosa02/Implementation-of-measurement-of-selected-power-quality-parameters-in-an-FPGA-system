// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\fft_ip2_fifo_data_OUT_block.v
...
// -------------------------------------------------------------
// 
// Module: fft_ip2_fifo_data_OUT_block
...
module fft_ip2_fifo_data_OUT_block
  ...
  fft_ip2_SimpleDualPortRAM_ge #(.AddrWidth(2),
                               ...
                               fft_ip2_fifo_data_OUT_classi_1 (.clk(clk),
                                                               .enb(enb),
                                                               .wr_din(In_rsvd),
                                                               .wr_addr(w_waddr),
                                                               .wr_en(w_we),  // ufix1
...
endmodule  // fft_ip2_fifo_data_OUT_block
