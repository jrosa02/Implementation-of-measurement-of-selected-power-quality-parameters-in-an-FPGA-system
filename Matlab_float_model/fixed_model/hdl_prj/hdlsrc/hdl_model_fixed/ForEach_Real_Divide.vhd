-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\ForEach_Real_Divide.vhd
...
END ForEach_Real_Divide;


ARCHITECTURE rtl OF ForEach_Real_Divide IS
  ...
  SIGNAL v_signed                         : signed(21 DOWNTO 0);  -- sfix22_En20
  SIGNAL Delay14_out1                     : signed(21 DOWNTO 0);  -- sfix22_En20
  ...
  SIGNAL Delay4_out1                      : signed(21 DOWNTO 0);  -- sfix22_En20
  ...
  SIGNAL Shift_and_cast_to_output_type_out1_signed : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Divide_by_zero_handler_out1      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Divide_by_zero_handler_out1_signed : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  u_Normalize_numerator : Normalize_numerator
    PORT MAP( clk => clk,
              ...
              u => std_logic_vector(Delay14_out1),  -- sfix22_En20
  ...
  u_Normalize_denominator : Normalize_denominator
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_25_0 => enb_1_25_0,
              u => std_logic_vector(Delay4_out1),  -- sfix22_En20
              validIn => Delay15_out1,
              x => x_1,  -- sfix22_En20
              e => e_1,  -- int32
  ...
  u_Shift_and_cast_to_output_type : Shift_and_cast_to_output_type
    PORT MAP( clk => clk,
              ...
              y => Shift_and_cast_to_output_type_out1  -- sfix16_En15
              );
  ...
  u_Divide_by_zero_handler : Divide_by_zero_handler
    PORT MAP( clk => clk,
              ...
              yOut => Divide_by_zero_handler_out1  -- sfix16_En15
              );
