-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_RADIX22FFT_SDF2_8
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDF2_8 IS
...
END Subsystem_ip_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDF2_8 IS
  ...
  COMPONENT Subsystem_ip_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_25_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
          xf_im                           :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
          dinf_im                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
          btf1_im                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
          btf2_re                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
          btf2_im                         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
          btfout_vld                      :   IN    std_logic;
          syncReset                       :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
          wrData_im                       :   OUT   std_logic_vector(19 DOWNTO 0);  -- sfix20_En11
  ...
  FOR ALL : Subsystem_ip_src_SDFCommutator8
    USE ENTITY work.Subsystem_ip_src_SDFCommutator8(rtl);

  -- Signals
  SIGNAL dout_7_1_re_signed               : signed(18 DOWNTO 0);  -- sfix19_En11
  SIGNAL din_re                           : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL dout_7_1_im_signed               : signed(18 DOWNTO 0);  -- sfix19_En11
  SIGNAL din_im                           : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL btf2_im                          : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL btf2_re                          : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL btf1_im                          : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL btf1_re                          : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL dinf_im                          : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL dinf_re                          : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL xf_im                            : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL x_im_signed                      : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL x_im_dly                         : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL wrData_re                        : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL x_re                             : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL x_re_signed                      : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL x_re_dly                         : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(20 DOWNTO 0);  -- sfix21_En11
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinf_vld                         : std_logic;
  SIGNAL btfout_vld                       : std_logic;
  SIGNAL dout_8_1_re_tmp                  : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL dout_8_1_im_tmp                  : std_logic_vector(19 DOWNTO 0);  -- ufix20

BEGIN
  u_dataMEM_im_0_8 : Subsystem_ip_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_8 : Subsystem_ip_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_8 : Subsystem_ip_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_25_0 => enb_1_25_0,
              dout_7_1_vld => dout_7_1_vld,
              xf_re => std_logic_vector(xf_re),  -- sfix20_En11
              xf_im => std_logic_vector(xf_im),  -- sfix20_En11
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix20_En11
              dinf_im => std_logic_vector(dinf_im),  -- sfix20_En11
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix20_En11
              btf1_im => std_logic_vector(btf1_im),  -- sfix20_En11
              btf2_re => std_logic_vector(btf2_re),  -- sfix20_En11
              btf2_im => std_logic_vector(btf2_im),  -- sfix20_En11
              ...
              wrAddr => wrAddr,  -- ufix3
              wrEnb => wrEnb,
              dout_8_1_re => dout_8_1_re_tmp,  -- sfix20_En11
              dout_8_1_im => dout_8_1_im_tmp,  -- sfix20_En11
              dout_8_1_vld => dout_8_1_vld
              );

  dout_7_1_re_signed <= signed(dout_7_1_re);

  din_re <= resize(dout_7_1_re_signed, 20);

  dout_7_1_im_signed <= signed(dout_7_1_im);

  din_im <= resize(dout_7_1_im_signed, 20);
