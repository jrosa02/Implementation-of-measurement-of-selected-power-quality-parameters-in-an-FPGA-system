// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_Complex4Multiply.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_Complex4Multiply
...
module Subsystem_ip2_src_Complex4Multiply
  ...
  input   reset;
  input   enb_1_2_0;
  input   signed [14:0] din_re;  // sfix15_En11
  input   signed [14:0] din_im;  // sfix15_En11
  input   din_3_vld_dly;
  input   signed [11:0] twdl_3_1_re;  // sfix12_En10
  input   signed [11:0] twdl_3_1_im;  // sfix12_En10
  input   syncReset;
  output  signed [14:0] dinXTwdl_re;  // sfix15_En11
  output  signed [14:0] dinXTwdl_im;  // sfix15_En11
  output  dinXTwdl_3_1_vld;


  reg signed [14:0] din_re_reg;  // sfix15_En11
  reg signed [14:0] din_im_reg;  // sfix15_En11
  ...
  reg signed [26:0] prod1_re;  // sfix27_En21
  reg signed [26:0] prod1_im;  // sfix27_En21
  reg signed [26:0] prod2_re;  // sfix27_En21
  reg signed [26:0] prod2_im;  // sfix27_En21
  reg  din_vld_dly1;
  reg  din_vld_dly2;
  reg  din_vld_dly3;
  reg  prod_vld;
  ...
  wire signed [27:0] Complex4Add_multRes_re_reg_next;  // sfix28_En21
  wire signed [27:0] Complex4Add_multRes_im_reg_next;  // sfix28_En21
  wire signed [27:0] Complex4Add_sub_cast;  // sfix28_En21
  wire signed [27:0] Complex4Add_sub_cast_1;  // sfix28_En21
  wire signed [27:0] Complex4Add_add_cast;  // sfix28_En21
  wire signed [27:0] Complex4Add_add_cast_1;  // sfix28_En21
  wire signed [27:0] mulResFP_re;  // sfix28_En21
  wire signed [27:0] mulResFP_im;  // sfix28_En21
  ...
  assign dinXTwdl_re = mulResFP_re[24:10];



  assign dinXTwdl_im = mulResFP_im[24:10];



  assign dinXTwdl_3_1_vld = dinXTwdl_3_1_vld_1;

endmodule  // Subsystem_ip2_src_Complex4Multiply
