// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_fifo_data_OUT
// Source Path: Subsystem_ip2/Subsystem_ip2_axi4_stream_master/Subsystem_ip2_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Subsystem_ip2_fifo_data_OUT
  ...
  Subsystem_ip2_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                            .DataWidth(16)
                                            )
                                          u_Subsystem_ip2_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                             .enb(enb),
                                                                                             .wr_din(In),
                                                                                             .wr_addr(w_waddr),
                                                                                             .wr_en(w_we),  // ufix1
  ...
  assign AFull = Num >= afull_num;



  assign Out = Out_1;

endmodule  // Subsystem_ip2_fifo_data_OUT
