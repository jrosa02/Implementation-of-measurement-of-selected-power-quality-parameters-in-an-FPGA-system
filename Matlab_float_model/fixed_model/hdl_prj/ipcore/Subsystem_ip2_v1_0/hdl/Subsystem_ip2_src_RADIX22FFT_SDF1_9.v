// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_RADIX22FFT_SDF1_9.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_RADIX22FFT_SDF1_9
...
module Subsystem_ip2_src_RADIX22FFT_SDF1_9
  ...
  Subsystem_ip2_src_Complex4Multiply_block2 u_MUL4 (.clk(clk),
                                                    .reset(reset),
                                                    .enb_1_2_0(enb_1_2_0),
  ...
  Subsystem_ip2_src_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                                .DataWidth(21)
                                                )
                                              u_dataMEM_im_0_9 (.clk(clk),
                                                                .enb_1_2_0(enb_1_2_0),
                                                                .wr_din(wrData_im),
                                                                .wr_addr(wrAddr),
                                                                .wr_en(wrEnb),
  ...
  Subsystem_ip2_src_SDFCommutator9 u_SDFCOMMUTATOR_9 (.clk(clk),
                                                      .reset(reset),
                                                      .enb_1_2_0(enb_1_2_0),
                                                      .din_9_vld_dly(din_9_vld_dly),
...
endmodule  // Subsystem_ip2_src_RADIX22FFT_SDF1_9
