// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_SDFCommuta_block9.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_SDFCommuta_block9
// Source Path: hdl_model_fixed/Subsystem1/Subsystem/FFT/RADIX22FFT_SDF1_11/SDFCommutator11
// Hierarchy Level: 4
// Model version: 1.110
// 
// -------------------------------------------------------------
...
module Subsystem_ip2_src_SDFCommuta_block9
  ...
  input   signed [22:0] xf_re;  // sfix23_En11
  input   signed [22:0] xf_im;  // sfix23_En11
  input   xf_vld;
  input   signed [22:0] dinXTwdlf_re;  // sfix23_En11
  input   signed [22:0] dinXTwdlf_im;  // sfix23_En11
  input   dinxTwdlf_vld;
  input   signed [22:0] btf1_re;  // sfix23_En11
  input   signed [22:0] btf1_im;  // sfix23_En11
  input   signed [22:0] btf2_re;  // sfix23_En11
  input   signed [22:0] btf2_im;  // sfix23_En11
  input   btf_vld;
  input   syncReset;
  output  signed [22:0] wrData_re;  // sfix23_En11
  output  signed [22:0] wrData_im;  // sfix23_En11
  output  wrAddr;  // ufix1
  output  wrEnb;
  ...
  reg signed [22:0] SDFCummutator_out_re;  // sfix23
  reg signed [22:0] SDFCummutator_out_im;  // sfix23
  reg  SDFCummutator_out_vld;
  reg  SDFCummutator_wrAddr_reg;  // ufix1
  reg [2:0] SDFCummutator_wrState;  // ufix3
  reg signed [22:0] SDFCummutator_wrData_re_reg;  // sfix23
  reg signed [22:0] SDFCummutator_wrData_im_reg;  // sfix23
  reg  SDFCummutator_wrEnb_reg;
  reg signed [22:0] SDFCummutator_wrXData_re_reg;  // sfix23
  reg signed [22:0] SDFCummutator_wrXData_im_reg;  // sfix23
  ...
  reg signed [22:0] SDFCummutator_btf1_re_dly;  // sfix23
  reg signed [22:0] SDFCummutator_btf1_im_dly;  // sfix23
  reg  SDFCummutator_btf1_vld_dly;
  reg signed [22:0] SDFCummutator_out_re_next;  // sfix23_En11
  reg signed [22:0] SDFCummutator_out_im_next;  // sfix23_En11
  reg  SDFCummutator_out_vld_next;
  reg  SDFCummutator_wrAddr_reg_next;  // ufix1
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [22:0] SDFCummutator_wrData_re_reg_next;  // sfix23_En11
  reg signed [22:0] SDFCummutator_wrData_im_reg_next;  // sfix23_En11
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [22:0] SDFCummutator_wrXData_re_reg_next;  // sfix23_En11
  reg signed [22:0] SDFCummutator_wrXData_im_reg_next;  // sfix23_En11
  ...
  reg signed [22:0] SDFCummutator_btf1_re_dly_next;  // sfix23_En11
  reg signed [22:0] SDFCummutator_btf1_im_dly_next;  // sfix23_En11
  reg  SDFCummutator_btf1_vld_dly_next;
  reg signed [22:0] wrData_re_1;  // sfix23_En11
  reg signed [22:0] wrData_im_1;  // sfix23_En11
  reg  wrAddr_1;  // ufix1
  reg  wrEnb_1;
  reg signed [22:0] xData_re;  // sfix23_En11
  reg signed [22:0] xData_im;  // sfix23_En11
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [22:0] dout0_re;  // sfix23_En11
  reg signed [22:0] dout0_im;  // sfix23_En11
  reg  dout0_vld;
  wire signed [22:0] xX_re;  // sfix23_En11
  wire signed [22:0] xX_im;  // sfix23_En11
  reg signed [22:0] SDFOutmux_btf2Pipe_re;  // sfix23
  reg signed [22:0] SDFOutmux_btf2Pipe_im;  // sfix23
  reg  SDFOutmux_btfPipe_vld;
  reg signed [22:0] SDFOutmux_btf2Pipe_re_next;  // sfix23_En11
  reg signed [22:0] SDFOutmux_btf2Pipe_im_next;  // sfix23_En11
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [22:0] dout_11_re_1;  // sfix23_En11
  reg signed [22:0] dout_11_im_1;  // sfix23_En11
  reg  dout_11_vld_1;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_11_re_1 = SDFOutmux_btf2Pipe_re;
    dout_11_im_1 = SDFOutmux_btf2Pipe_im;
    dout_11_vld_1 = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_11_vld = dout_11_vld_1;

endmodule  // Subsystem_ip2_src_SDFCommuta_block9
