// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_SDFCommuta.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_SDFCommuta
// Source Path: hdl_model_fixed/Subsystem1/Subsystem/FFT/RADIX22FFT_SDF1_1/SDFCommutator1
// Hierarchy Level: 4
// Model version: 1.110
// 
// -------------------------------------------------------------
...
module Subsystem_ip2_src_SDFCommuta
  ...
  input   enb;
  input   din_1_vld_dly;
  input   signed [12:0] xf_re;  // sfix13_En11
  input   signed [12:0] xf_im;  // sfix13_En11
  input   xf_vld;
  input   signed [12:0] dinXTwdlf_re;  // sfix13_En11
  input   signed [12:0] dinXTwdlf_im;  // sfix13_En11
  input   dinxTwdlf_vld;
  input   signed [12:0] btf1_re;  // sfix13_En11
  input   signed [12:0] btf1_im;  // sfix13_En11
  input   signed [12:0] btf2_re;  // sfix13_En11
  input   signed [12:0] btf2_im;  // sfix13_En11
  input   btf_vld;
  input   syncReset;
  output  signed [12:0] wrData_re;  // sfix13_En11
  ...
  reg signed [12:0] SDFCummutator_out_re;  // sfix13
  reg signed [12:0] SDFCummutator_out_im;  // sfix13
  reg  SDFCummutator_out_vld;
  reg [9:0] SDFCummutator_wrAddr_reg;  // ufix10
  reg [2:0] SDFCummutator_wrState;  // ufix3
  reg [1:0] SDFCummutator_mem_btf_switch;  // ufix2
  reg [9:0] SDFCummutator_rdCnt;  // ufix10
  reg signed [12:0] SDFCummutator_wrData_re_reg;  // sfix13
  reg signed [12:0] SDFCummutator_wrData_im_reg;  // sfix13
  reg  SDFCummutator_wrEnb_reg;
  reg signed [12:0] SDFCummutator_wrXData_re_reg;  // sfix13
  reg signed [12:0] SDFCummutator_wrXData_im_reg;  // sfix13
  ...
  reg signed [12:0] SDFCummutator_out_re_next;  // sfix13_En11
  reg signed [12:0] SDFCummutator_out_im_next;  // sfix13_En11
  reg  SDFCummutator_out_vld_next;
  reg [9:0] SDFCummutator_wrAddr_reg_next;  // ufix10
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg [1:0] SDFCummutator_mem_btf_switch_next;  // ufix2
  reg [9:0] SDFCummutator_rdCnt_next;  // ufix10
  reg signed [12:0] SDFCummutator_wrData_re_reg_next;  // sfix13_En11
  reg signed [12:0] SDFCummutator_wrData_im_reg_next;  // sfix13_En11
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [12:0] SDFCummutator_wrXData_re_reg_next;  // sfix13_En11
  reg signed [12:0] SDFCummutator_wrXData_im_reg_next;  // sfix13_En11
  ...
  reg signed [12:0] wrData_re_1;  // sfix13_En11
  reg signed [12:0] wrData_im;  // sfix13_En11
  reg [9:0] wrAddr_1;  // ufix10
  reg  wrEnb_1;
  reg signed [12:0] xData_re;  // sfix13_En11
  reg signed [12:0] xData_im;  // sfix13_En11
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [12:0] dout0_re;  // sfix13_En11
  reg signed [12:0] dout0_im;  // sfix13_En11
  reg  dout0_vld;
  wire signed [12:0] xX_re;  // sfix13_En11
  wire signed [12:0] xX_im;  // sfix13_En11
  reg signed [12:0] SDFOutmux_btf2Pipe_re;  // sfix13
  reg signed [12:0] SDFOutmux_btf2Pipe_im;  // sfix13
  reg  SDFOutmux_btfPipe_vld;
  reg signed [12:0] SDFOutmux_btf2Pipe_re_next;  // sfix13_En11
  reg signed [12:0] SDFOutmux_btf2Pipe_im_next;  // sfix13_En11
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [12:0] dout_1_1_re_1;  // sfix13_En11
  reg signed [12:0] dout_1_1_im_1;  // sfix13_En11
  reg  dout_1_1_vld_1;
  ...
  always @(posedge clk)
    begin : SDFCummutator_process
      if (reset == 1'b1) begin
        SDFCummutator_out_re <= 13'sb0000000000000;
        SDFCummutator_out_im <= 13'sb0000000000000;
        SDFCummutator_wrData_re_reg <= 13'sb0000000000000;
        SDFCummutator_wrData_im_reg <= 13'sb0000000000000;
        SDFCummutator_wrEnb_reg <= 1'b0;
        SDFCummutator_out_vld <= 1'b0;
        SDFCummutator_wrState <= 3'b000;
        SDFCummutator_mem_btf_switch <= 2'b00;
        SDFCummutator_wrAddr_reg <= 10'b0000000000;
        SDFCummutator_rdCnt <= 10'b0000000000;
        SDFCummutator_wrXData_re_reg <= 13'sb0000000000000;
        SDFCummutator_wrXData_im_reg <= 13'sb0000000000000;
  ...
  always @(SDFCummutator_XState, SDFCummutator_mem_btf_switch, SDFCummutator_out_im,
    ...
    case ( SDFCummutator_XState)
      3'b000 :
        begin
          SDFCummutator_wrXData_re_reg_next = 13'sb0000000000000;
          SDFCummutator_wrXData_im_reg_next = 13'sb0000000000000;
          ...
          if ((SDFCummutator_wrEnb_xmem && (SDFCummutator_wrAddr_reg == 10'b1111110111)) && 
    ...
    case ( SDFCummutator_mem_btf_switch)
      2'b00 :
        begin
          ...
          SDFCummutator_rdCnt_next = 10'b0000000000;
      ...
      2'b01 :
        begin
          SDFCummutator_mem_btf_switch_next = 2'b01;
          SDFCummutator_rdEnb_xmem_next = 1'b0;
          if ((SDFCummutator_rdCnt == 10'b1111111111) && btf_vld) begin
            SDFCummutator_mem_btf_switch_next = 2'b10;
          end
          if (btf_vld) begin
            SDFCummutator_rdCnt_next = SDFCummutator_rdCnt + 10'b0000000001;
          end
      ...
      2'b10 :
        begin
          SDFCummutator_mem_btf_switch_next = 2'b10;
          if ((SDFCummutator_rdCnt == 10'b1111110111) && xf_vld) begin
            SDFCummutator_mem_btf_switch_next = 2'b01;
            SDFCummutator_rdEnb_xmem_next = 1'b1;
          end
          if (xf_vld) begin
            if (SDFCummutator_rdCnt == 10'b1111110111) begin
              SDFCummutator_rdCnt_next = 10'b0000000000;
            end
            else begin
              SDFCummutator_rdCnt_next = SDFCummutator_rdCnt + 10'b0000000001;
    ...
    case ( SDFCummutator_wrState)
      3'b000 :
        begin
          ...
          SDFCummutator_wrAddr_reg_next = 10'b0000000000;
      ...
      3'b001 :
        begin
          ...
          SDFCummutator_wrEnb_xmem_next = 1'b0;
          if (SDFCummutator_wrAddr_reg == 10'b1111111111) begin
            if (btf_vld) begin
            ...
            SDFCummutator_wrState_next = 3'b001;
            SDFCummutator_wrAddr_reg_next = SDFCummutator_wrAddr_reg + 10'b0000000001;
            SDFCummutator_wrEnb_reg_next = 1'b1;
            SDFCummutator_wrData_re_reg_next = dinXTwdlf_re;
            SDFCummutator_wrData_im_reg_next = dinXTwdlf_im;
          end
      ...
      3'b010 :
        begin
          ...
          SDFCummutator_wrEnb_reg_next = 1'b0;
          SDFCummutator_wrEnb_xmem_next = 1'b0;
          if (SDFCummutator_wrAddr_reg == 10'b1111110110) begin
            SDFCummutator_wrEnb_xmem_next = 1'b1;
          end
          if (SDFCummutator_wrAddr_reg == 10'b1111110111) begin
            SDFCummutator_wrAddr_reg_next = SDFCummutator_wrAddr_reg + 10'b0000000001;
  ...
  always @(posedge clk)
    begin : SDFOutmux_process
      if (reset == 1'b1) begin
        SDFOutmux_btf2Pipe_re <= 13'sb0000000000000;
        SDFOutmux_btf2Pipe_im <= 13'sb0000000000000;
...
endmodule  // Subsystem_ip2_src_SDFCommuta
