// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdl_model_fixed\Subsystem_ip2_src_SDFCommuta_block2.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip2_src_SDFCommuta_block2
// Source Path: hdl_model_fixed/Subsystem1/Subsystem/FFT/RADIX22FFT_SDF2_4/SDFCommutator4
// Hierarchy Level: 4
// Model version: 1.110
// 
// -------------------------------------------------------------
...
module Subsystem_ip2_src_SDFCommuta_block2
  ...
  input   enb;
  input   dout_3_1_vld;
  input   signed [15:0] xf_re;  // sfix16_En11
  input   signed [15:0] xf_im;  // sfix16_En11
  input   xf_vld;
  input   signed [15:0] dinf_re;  // sfix16_En11
  input   signed [15:0] dinf_im;  // sfix16_En11
  input   dinf_vld;
  input   signed [15:0] btf1_re;  // sfix16_En11
  input   signed [15:0] btf1_im;  // sfix16_En11
  input   signed [15:0] btf2_re;  // sfix16_En11
  input   signed [15:0] btf2_im;  // sfix16_En11
  input   btfout_vld;
  input   syncReset;
  output  signed [15:0] wrData_re;  // sfix16_En11
  output  signed [15:0] wrData_im;  // sfix16_En11
  ...
  reg signed [15:0] SDFCummutator_out_re_next;  // sfix16_En11
  reg signed [15:0] SDFCummutator_out_im_next;  // sfix16_En11
  ...
  reg signed [15:0] SDFCummutator_wrData_re_reg_next;  // sfix16_En11
  reg signed [15:0] SDFCummutator_wrData_im_reg_next;  // sfix16_En11
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [15:0] SDFCummutator_wrXData_re_reg_next;  // sfix16_En11
  reg signed [15:0] SDFCummutator_wrXData_im_reg_next;  // sfix16_En11
  ...
  reg signed [15:0] wrData_re_1;  // sfix16_En11
  reg signed [15:0] wrData_im_1;  // sfix16_En11
  reg [6:0] wrAddr_1;  // ufix7
  reg  wrEnb_1;
  reg signed [15:0] xData_re;  // sfix16_En11
  reg signed [15:0] xData_im;  // sfix16_En11
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [15:0] dout0_re;  // sfix16_En11
  reg signed [15:0] dout0_im;  // sfix16_En11
  reg  dout0_vld;
  wire signed [15:0] xX_re;  // sfix16_En11
  wire signed [15:0] xX_im;  // sfix16_En11
  reg signed [15:0] SDFOutmux_btf2Pipe_re;  // sfix16
  reg signed [15:0] SDFOutmux_btf2Pipe_im;  // sfix16
  reg  SDFOutmux_btfPipe_vld;
  reg signed [15:0] SDFOutmux_btf2Pipe_re_next;  // sfix16_En11
  reg signed [15:0] SDFOutmux_btf2Pipe_im_next;  // sfix16_En11
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [15:0] dout_4_1_re_1;  // sfix16_En11
  reg signed [15:0] dout_4_1_im_1;  // sfix16_En11
  reg  dout_4_1_vld_1;
    ...
    case ( SDFCummutator_XState)
      3'b000 :
        begin
          ...
          if ((SDFCummutator_wrEnb_xmem && (SDFCummutator_wrAddr_reg == 7'b1110111)) && 
    ...
    case ( SDFCummutator_mem_btf_switch)
      ...
      2'b01 :
        begin
          SDFCummutator_mem_btf_switch_next = 2'b01;
          SDFCummutator_rdEnb_xmem_next = 1'b0;
          if ((SDFCummutator_rdCnt == 7'b1111111) && btfout_vld) begin
...
endmodule  // Subsystem_ip2_src_SDFCommuta_block2
